<div class="tw-flex tw-flex-col tw-gap-[calc(5/var(--base-screen)*100vw)] lg:tw-gap-[calc(12/var(--base-screen)*100vw)] xl:tw-gap-[12px]">
  <a class="tw-relative hover:tw-opacity-95" href="{{ $link }}">
    <div class="tw-relative tw-flex tw-aspect-[375/360] tw-w-full tw-items-end tw-rounded-2xl tw-bg-cover tw-bg-no-repeat tw-drop-shadow-lg tw-overflow-hidden" style="background-image: url({{ $profile_url }});">
