<div class="tw-flex tw-h-[calc(30/var(--base-screen)*100vw)] lg:tw-h-[calc(68/var(--base-screen)*100vw)] xl:tw-h-[68px] tw-mx-auto tw-max-w-[calc(205/var(--base-screen)*100vw)] lg:tw-max-w-[calc((700/1990)*100vw)] xl:tw-max-w-[700px] tw-overflow-hidden ptw-x-5 tw-w-full tw-items-center tw-bg-white tw-rounded-full tw-relative tw-z-[51] tw-shadow-[0px_0px_1px_0px_rgba(0,0,0,0.35)] lg:tw-shadow-[0px_0px_52px_rgba(0,0,0,0.35)]">
  <input
    id="searchBarField"
