<div class="tw-flex tw-h-[calc(30/var(--base-screen)*100vw)] lg:tw-h-[calc(68/var(--base-screen)*100vw)] xl:tw-h-[68px] tw-mx-auto tw-max-w-[calc(205/var(--base-screen)*100vw)] md:tw-max-w-[calc(300/var(--base-screen)*100vw)] lg:tw-max-w-[calc((700/1990)*100vw)] xl:tw-max-w-[700px] tw-overflow-hidden ptw-x-5 tw-w-full tw-items-center tw-bg-white tw-rounded-full tw-relative tw-z-[51] tw-shadow-[0px_0px_1px_0px_rgba(0,0,0,0.35)] lg:tw-shadow-[0px_0px_52px_rgba(0,0,0,0.35)]">
  <input
    id="searchBarField"
    class="search-input tw-hidden lg:tw-block tw-text-[calc((12/var(--base-screen))*100vw)] lg:tw-text-[calc((28/var(--base-screen))*100vw)] xl:tw-text-[28px] tw-text-[#2A2A2E] tw-h-[calc(18/var(--base-screen))*100vw] lg:tw-h-[calc(42/var(--base-screen))*100vw] xl:tw-h-[42px] tw-w-full tw-outline-none tw-text-center tw-opacity-50 focus:tw-ring-0"
    autocomplete="on"
  ...
  <input
    ...
    class="mobile-search-input lg:tw-hidden tw-text-[calc((12/var(--base-screen))*100vw)] lg:tw-text-[calc((28/var(--base-screen))*100vw)] xl:tw-text-[28px] tw-text-[#2A2A2E] tw-h-[calc(18/var(--base-screen))*100vw] lg:tw-h-[calc(42/var(--base-screen))*100vw] xl:tw-h-[42px] tw-w-full tw-outline-none tw-text-center tw-opacity-50 focus:tw-ring-0"
    autocomplete="on"
    aria-autocomplete="inline"
    list="suggestion"
