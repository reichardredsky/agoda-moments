<div class="tw-w-full tw-flex tw-flex-col tw-relative tw-h-[calc((340/var(--base-screen))*100vw)] sm:tw-h-[calc((340/640)*100vw)] md:tw-h-[calc((340/768)*100vw)] lg:tw-h-[calc(700/var(--base-screen)*100vw)] xl:tw-h-[700px] tw-bg-cover tw-bg-no-repeat tw-bg-center" style="background-image: url(@asset('images/backgrounds/profile-cover.png'));">
  ...
  <div class="tw-w-full max-screen tw-relative tw-flex tw-z-10 tw-flex-col tw-mt-[calc(17/var(--base-screen)*100vw)] lg:tw-mt-[calc(46/var(--base-screen)*100vw)] xl:tw-mt-[46px]">
    ...
    <div class="tw-mt-[calc(54/var(--base-screen)*100vw)] lg:tw-mt-[calc(68/var(--base-screen)*100vw)] xl:tw-mt-[68px] tw-flex tw-gap-x-[calc(10/var(--base-screen)*100vw)] lg:tw-gap-x-[calc(65/var(--base-screen)*100vw)]  xl:tw-gap-x-[65px]">
      <div class="tw-w-[calc(109.34/var(--base-screen)*100vw)] tw-h-[calc(109.34/var(--base-screen)*100vw)] lg:tw-w-[calc(240.56/var(--base-screen)*100vw)] xl:tw-w-[240.56px] lg:tw-h-[calc(240.56/var(--base-screen)*100vw)] xl:tw-h-[240.56px]">
        <img src="https://i.pravatar.cc/300" alt="Profile Picture" class="tw-object-fill tw-rounded-full" />
      </div>
      <div class="tw-flex tw-flex-col">
        <div class="tw-flex tw-flex-col tw-w-full">
          <!-- Profile Name -->
          <h2 class="tw-text-white tw-leading-[calc(33.6/var(--base-screen)*100vw)] lg:tw-leading-none tw-font-agoda-sans-stemless tw-font-[900] tw-text-[calc(28/var(--base-screen)*100vw)] lg:tw-text-[calc(48/var(--base-screen)*100vw)] xl:tw-text-[48px]">@Zoesennett</h2>
          <!-- Profile  -->
